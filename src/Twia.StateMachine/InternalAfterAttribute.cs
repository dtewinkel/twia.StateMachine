...
/// <summary>
/// Define an internal transition in the state the attribute is applied to when the time specified in <see cref="After"/> has elapsed
...
public class InternalAfterAttribute(
    string after,
