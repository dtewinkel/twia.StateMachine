...
/// <summary>
/// Indicate that the class is a state machine with async support and should have state machine logic generated.
/// </summary>
/// <remarks>
...
public class AsyncStateMachineAttribute : Attribute
{
    /// <summary>
