...
public static class AsyncStateMachineSourceBuilder
{
    public static void AddSource(SourceProductionContext context, StateMachineDeclaration declaration)
    {
        try
        {
            ...
            var afterTransitionsBuilder = new AfterTransitionsBuilder(document, declaration, classCommonBuilder,
                statesBuilder, triggersBuilder);
            ...
            var statesManagementBuilder = new StatesManagementBuilder(document, statesBuilder, triggersBuilder,
                afterTransitionsBuilder, observableBuilder);

            var builders = new List<BuilderBase>
                {
                    statesBuilder, statesManagementBuilder, triggersBuilder, triggersEnumBuilder,
                    afterTransitionsBuilder, observableBuilder
                }
            ...
            codeAdded = GenerateAll(builders, document, codeAdded,
                sourceBuilder => sourceBuilder.AddPublicProperties());
